...
const galleryItems = [
  {
    id: 1,
    title: 'Школа после ремонта',
    year: '2022',
    src: `${PHOTOS}school-renovated.jpg`,
    description: 'Школа после капитального ремонта',
    category: 'Наше село',
  },
  {
    id: 2,
    title: 'Внутри школы',
    year: '2022',
    src: `${PHOTOS}school-interior.jpg`,
    description: 'Обновлённые коридоры и классы',
    category: 'Наше село',
  },
  {
    id: 3,
    title: 'Ремонт школы',
    year: '2023',
    src: `${PHOTOS}school-repairs.jpg`,
    description: 'Ремонтные работы в школе',
    category: 'Наше село',
  },
  {
    id: 4,
    title: 'Панорама села',
    year: '',
    src: `${PHOTOS}village-panorama.jpg`,
    description: 'Вид на село Маис',
    category: 'Наше село',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    title: 'Дома села',
    year: '',
    src: `${PHOTOS}village-houses.jpg`,
    description: 'Традиционные дома',
    category: 'Наше село',
  },
  {
    id: 7,
    title: 'Дом культуры',
    year: '2022',
    src: `${PHOTOS}dk-mais.jpg`,
    description: 'Дом культуры после ремонта',
    category: 'Наше село',
  },
  {
    id: 8,
    title: 'ДК до ремонта',
    year: '2021',
    src: `${PHOTOS}dk-before.jpg`,
    description: 'Дом культуры до ремонта',
    category: 'Наше село',
  },
  {
    id: 9,
    ...
    description: 'Храм Боголюбской Иконы Божией Матери',
    category: 'Наше село',
  },
  {
    id: 10,
    ...
    description: 'Памятник погибшим воинам',
    category: 'Наше село',
  },
  ...[
    ...
    title: `Фото ${i + 1}`,
    year: '',
    src: `${PHOTOS}photo_${n}_2026-07-19_15-27-38.jpg`,
    description: 'Фото выпускников',
    category: 'Выпускники',
  })),
];
...
export default function Gallery() {
  ...
  const prevPhoto = () => setLightbox(i => (i > 0 ? i - 1 : filtered.length - 1));
  const nextPhoto = () => setLightbox(i => (i < filtered.length - 1 ? i + 1 : 0));
            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  padding: '8px 20px',
                  borderRadius: 20,
                  border: activeCategory === cat ? '2px solid #6c5ce7' : '2px solid #ddd',
                  background: activeCategory === cat ? '#6c5ce7' : '#fff',
      ...
      <section className="section">
        <div className="container">
          ...
          >
            ...
            <p>
              Отправьте нам ваши школьные фотографии, и мы разместим их здесь.
              Каждое фото — это кусочек нашей общей памяти.
            </p>
          </motion.div>
        </div>
      </section>
